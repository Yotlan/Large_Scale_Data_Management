...
## COPY SPARK CODE
gsutil cp dataproc_spark_cpart.py gs://tppascal_bucket/
...
gcloud dataproc jobs submit pyspark --region europe-west1 --cluster cluster-a35a gs://tppascal_bucket/dataproc_spark_cpart.py  -- gs://public_lddm_data/page_links_en.nt.bz2 3 2
